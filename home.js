...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const birthdayDate = new Date("July 8, 2026 00:00:00").getTime();

  // CUSTOMIZE: Change this greeting message
  const greetingText =
    "Hey my love, you are the sweetest, brightest, and most beautiful part of my world. Today is all about your smile, your heart, and the happiness you bring into my life every single day. I adore you more than words can say. 💖";
